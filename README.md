...
· Text‑to‑speech for questions (offline)
...
Double‑click Start Live Server.bat (included in the project) to launch the development server automatically.
...
For questions, bugs, or feature requests, contact me (@Janneske2001) or open an issue in the repository.
