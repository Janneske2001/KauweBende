...
export function initRulesModal() {
    ...
    const gameplayTexts = [
        ...
        De jongste speler mag beginnen. Spelers moeten een kaart uit hun hand op tafel leggen die OF het symbool OF de kleur matched van de laatste gespeelde kaart op de tafel. De kleur van de kaart die wordt neergelegd bepaalt welke categorie van vragen op de tablet geselecteerd moet worden. De willekeurig gekozen vraag moet worden beantwoord door de speler. Andere spelers mogen ook antwoorden of erover praten als ze willen. Het doel van het spel is namelijk is dat de groep elkaar leert kennen en samen praten, bijna vergetend dat het spel er is.<br><br>
